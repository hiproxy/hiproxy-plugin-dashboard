...
"use strict";
/* WEBPACK VAR INJECTION */(function(global, process) {/* unused harmony export Promise */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TPromise; });
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(16), __webpack_require__(8)))
...
"use strict";
/* unused harmony export ASTNodeImpl */
/* unused harmony export NullASTNodeImpl */
/* unused harmony export BooleanASTNodeImpl */
/* unused harmony export ArrayASTNodeImpl */
/* unused harmony export NumberASTNodeImpl */
/* unused harmony export StringASTNodeImpl */
/* unused harmony export PropertyASTNodeImpl */
/* unused harmony export ObjectASTNodeImpl */
/* harmony export (immutable) */ __webpack_exports__["a"] = asSchema;
/* unused harmony export EnumMatch */
/* unused harmony export ValidationResult */
/* harmony export (immutable) */ __webpack_exports__["e"] = newJSONDocument;
/* harmony export (immutable) */ __webpack_exports__["d"] = getNodeValue;
/* harmony export (immutable) */ __webpack_exports__["c"] = getNodePath;
/* harmony export (immutable) */ __webpack_exports__["b"] = contains;
/* unused harmony export JSONDocument */
/* harmony export (immutable) */ __webpack_exports__["f"] = parse;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__jsonc_parser_main_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_objects_js__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__fillers_vscode_nls_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__vscode_uri_index_js__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__vscode_languageserver_types_main_js__ = __webpack_require__(0);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var localize = __WEBPACK_IMPORTED_MODULE_3__fillers_vscode_nls_js__["a" /* loadMessageBundle */]();
    ...
    ValidationResult.prototype.mergeEnumValues = function (validationResult) {
        if (!this.enumValueMatch && !validationResult.enumValueMatch && this.enumValues && validationResult.enumValues) {
            ...
            for (var _i = 0, _a = this.problems; _i < _a.length; _i++) {
                var error = _a[_i];
                if (error.code === __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].EnumValueMismatch) {
...
function getNodeValue(node) {
    return __WEBPACK_IMPORTED_MODULE_0__jsonc_parser_main_js__["e" /* getNodeValue */](node);
}
function getNodePath(node) {
    return __WEBPACK_IMPORTED_MODULE_0__jsonc_parser_main_js__["d" /* getNodePath */](node);
}
...
var JSONDocument = /** @class */ (function () {
    ...
    JSONDocument.prototype.getNodeFromOffset = function (offset, includeRightBound) {
        if (includeRightBound === void 0) { includeRightBound = false; }
        if (this.root) {
            return __WEBPACK_IMPORTED_MODULE_0__jsonc_parser_main_js__["b" /* findNodeAtOffset */](this.root, offset, includeRightBound);
        }
        return void 0;
    };
    ...
    JSONDocument.prototype.validate = function (textDocument, schema) {
        if (this.root && schema) {
            ...
            return validationResult.problems.map(function (p) {
                var range = __WEBPACK_IMPORTED_MODULE_5__vscode_languageserver_types_main_js__["i" /* Range */].create(textDocument.positionAt(p.location.offset), textDocument.positionAt(p.location.offset + p.location.length));
                return __WEBPACK_IMPORTED_MODULE_5__vscode_languageserver_types_main_js__["c" /* Diagnostic */].create(range, p.message, p.severity, p.code);
            });
        }
        return null;
    };
    ...
    function _validateNode() {
        ...
        if (Array.isArray(schema.type)) {
            if (!schema.type.some(matchesType)) {
                validationResult.problems.push({
                    ...
                    severity: __WEBPACK_IMPORTED_MODULE_5__vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Warning,
        ...
        if (Array.isArray(schema.enum)) {
            ...
            for (var _i = 0, _a = schema.enum; _i < _a.length; _i++) {
                var e = _a[_i];
                if (__WEBPACK_IMPORTED_MODULE_1__utils_objects_js__["a" /* equals */](val, e)) {
                    enumValueMatch = true;
                    break;
                }
            }
            ...
            if (!enumValueMatch) {
                validationResult.problems.push({
                    location: { offset: node.offset, length: node.length },
                    severity: __WEBPACK_IMPORTED_MODULE_5__vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Warning,
                    code: __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].EnumValueMismatch,
        ...
        if (schema.const) {
            var val = getNodeValue(node);
            if (!__WEBPACK_IMPORTED_MODULE_1__utils_objects_js__["a" /* equals */](val, schema.const)) {
                validationResult.problems.push({
                    location: { offset: node.offset, length: node.length },
                    severity: __WEBPACK_IMPORTED_MODULE_5__vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Warning,
                    code: __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].EnumValueMismatch,
                ...
                case 'uri-reference':
                    {
                        ...
                        if (!node.value) {
                            ...
                            try {
                                var uri = __WEBPACK_IMPORTED_MODULE_4__vscode_uri_index_js__["a" /* default */].parse(node.value);
...
function parse(textDocument, config) {
    ...
    var scanner = __WEBPACK_IMPORTED_MODULE_0__jsonc_parser_main_js__["a" /* createScanner */](text, false);
            ...
            switch (token_1) {
                ...
                case 13 /* BlockCommentTrivia */:
                    if (Array.isArray(commentRanges)) {
                        commentRanges.push(__WEBPACK_IMPORTED_MODULE_5__vscode_languageserver_types_main_js__["i" /* Range */].create(textDocument.positionAt(scanner.getTokenOffset()), textDocument.positionAt(scanner.getTokenOffset() + scanner.getTokenLength())));
                    }
                    break;
                case 15 /* Trivia */:
    ...
    function _errorAtRange(message, code, startOffset, endOffset, severity) {
        if (severity === void 0) { severity = __WEBPACK_IMPORTED_MODULE_5__vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Error; }
        if (problems.length === 0 || startOffset !== lastProblemOffset) {
            var range = __WEBPACK_IMPORTED_MODULE_5__vscode_languageserver_types_main_js__["i" /* Range */].create(textDocument.positionAt(startOffset), textDocument.positionAt(endOffset));
            problems.push(__WEBPACK_IMPORTED_MODULE_5__vscode_languageserver_types_main_js__["c" /* Diagnostic */].create(range, message, severity, code, textDocument.languageId));
    ...
    function _checkScanError() {
        switch (scanner.getTokenError()) {
            case 4 /* InvalidUnicode */:
                _error(localize('InvalidUnicode', 'Invalid unicode sequence in string.'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].InvalidUnicode);
                return true;
            case 5 /* InvalidEscapeCharacter */:
                _error(localize('InvalidEscapeCharacter', 'Invalid escape character in string.'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].InvalidEscapeCharacter);
                return true;
            case 3 /* UnexpectedEndOfNumber */:
                _error(localize('UnexpectedEndOfNumber', 'Unexpected end of number.'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].UnexpectedEndOfNumber);
                return true;
            case 1 /* UnexpectedEndOfComment */:
                _error(localize('UnexpectedEndOfComment', 'Unexpected end of comment.'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].UnexpectedEndOfComment);
                return true;
            case 2 /* UnexpectedEndOfString */:
                _error(localize('UnexpectedEndOfString', 'Unexpected end of string.'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].UnexpectedEndOfString);
                return true;
            case 6 /* InvalidCharacter */:
                _error(localize('InvalidCharacter', 'Invalid characters in string. Control characters must be escaped.'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].InvalidCharacter);
                return true;
        }
        return false;
    }
    ...
    function _parseArray(parent) {
        ...
        while (scanner.getToken() !== 4 /* CloseBracketToken */ && scanner.getToken() !== 17 /* EOF */) {
            if (scanner.getToken() === 5 /* CommaToken */) {
                if (!needsComma) {
                    _error(localize('ValueExpected', 'Value expected'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].ValueExpected);
                }
                var commaOffset = scanner.getTokenOffset();
                _scanNext(); // consume comma
                if (scanner.getToken() === 4 /* CloseBracketToken */) {
                    if (needsComma) {
                        _errorAtRange(localize('TrailingComma', 'Trailing comma'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].TrailingComma, commaOffset, commaOffset + 1);
                    }
                    continue;
                }
            }
            else if (needsComma) {
                _error(localize('ExpectedComma', 'Expected comma'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].CommaExpected);
            }
            var item = _parseValue(node, count++);
            if (!item) {
                _error(localize('PropertyExpected', 'Value expected'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].ValueExpected, null, [], [4 /* CloseBracketToken */, 5 /* CommaToken */]);
            }
            else {
        ...
        if (scanner.getToken() !== 4 /* CloseBracketToken */) {
            return _error(localize('ExpectedCloseBracket', 'Expected comma or closing bracket'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].CommaOrCloseBacketExpected, node);
        }
    ...
    function _parseProperty(parent, keysSeen) {
        ...
        if (!key) {
            if (scanner.getToken() === 16 /* Unknown */) {
                ...
                _error(localize('DoubleQuotesExpected', 'Property keys must be doublequoted'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].Undefined);
        ...
        if (seen) {
            _errorAtRange(localize('DuplicateKeyWarning', "Duplicate object key"), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].DuplicateKey, node.keyNode.offset, node.keyNode.offset + node.keyNode.length, __WEBPACK_IMPORTED_MODULE_5__vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Warning);
            if (typeof seen === 'object') {
                _errorAtRange(localize('DuplicateKeyWarning', "Duplicate object key"), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].DuplicateKey, seen.keyNode.offset, seen.keyNode.offset + seen.keyNode.length, __WEBPACK_IMPORTED_MODULE_5__vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Warning);
            }
        ...
        if (scanner.getToken() === 6 /* ColonToken */) {
            ...
            _error(localize('ColonExpected', 'Colon expected'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].ColonExpected);
        ...
        if (!value) {
            return _error(localize('ValueExpected', 'Value expected'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].ValueExpected, node, [], [2 /* CloseBraceToken */, 5 /* CommaToken */]);
        }
    ...
    function _parseObject(parent) {
        ...
        while (scanner.getToken() !== 2 /* CloseBraceToken */ && scanner.getToken() !== 17 /* EOF */) {
            if (scanner.getToken() === 5 /* CommaToken */) {
                if (!needsComma) {
                    _error(localize('PropertyExpected', 'Property expected'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].PropertyExpected);
                }
                var commaOffset = scanner.getTokenOffset();
                _scanNext(); // consume comma
            ...
            if (!property) {
                _error(localize('PropertyExpected', 'Property expected'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].PropertyExpected, null, [], [2 /* CloseBraceToken */, 5 /* CommaToken */]);
            }
            else {
        ...
        if (scanner.getToken() !== 2 /* CloseBraceToken */) {
            return _error(localize('ExpectedCloseBrace', 'Expected comma or closing brace'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].CommaOrCloseBraceExpected, node);
        }
        return _finalize(node, true);
    }
        ...
        if (scanner.getTokenError() === 0 /* None */) {
            ...
            try {
                ...
                if (typeof numberValue !== 'number') {
                    return _error(localize('InvalidNumberFormat', 'Invalid number format.'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].Undefined, node);
                }
    ...
    if (token !== 17 /* EOF */) {
        ...
        if (!_root) {
            _error(localize('Invalid symbol', 'Expected a JSON object, array or literal.'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].Undefined);
        }
        else if (scanner.getToken() !== 17 /* EOF */) {
            _error(localize('End of file expected', 'End of file expected.'), __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["a" /* ErrorCode */].Undefined);
        }
    }
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return parse; });
/* unused harmony export parseTree */
/* unused harmony export findNodeAtLocation */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return findNodeAtOffset; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return getNodePath; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return getNodeValue; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__impl_format_js__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__impl_edit_js__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__impl_scanner_js__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__impl_parser_js__ = __webpack_require__(21);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* unused harmony reexport TextEdit */
/* unused harmony reexport Color */
/* unused harmony reexport ColorInformation */
/* unused harmony reexport ColorPresentation */
/* unused harmony reexport FoldingRange */
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__["e"]; });
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(8), __webpack_require__(16)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__position_js__ = __webpack_require__(2);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__winjs_base_js__ = __webpack_require__(1);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
__WEBPACK_IMPORTED_MODULE_0__winjs_base_js__["a" /* TPromise */].addEventListener('error', promiseErrorHandler);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = convertSimple2RegExpPattern;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__platform_js__ = __webpack_require__(7);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__diffChange_js__ = __webpack_require__(27);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__errors_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__functional_js__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lifecycle_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__linkedList_js__ = __webpack_require__(37);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
        ...
        if (this._listeners) {
            ...
            while (this._deliveryQueue.length > 0) {
                ...
                try {
                    ...
                    Object(__WEBPACK_IMPORTED_MODULE_0__errors_js__["c" /* onUnexpectedError */])(e);
                }
            }
        }
    };
...
var Relay = /** @class */ (function () {
    function Relay() {
        ...
        this.disposable = __WEBPACK_IMPORTED_MODULE_2__lifecycle_js__["a" /* Disposable */].None;
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__scanner_js__ = __webpack_require__(13);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__editor_editor_worker_js__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__jsonWorker_js__ = __webpack_require__(43);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
self.onmessage = function () {
    ...
    __WEBPACK_IMPORTED_MODULE_0__editor_editor_worker_js__["a" /* initialize */](function (ctx, createData) {
        return new __WEBPACK_IMPORTED_MODULE_1__jsonWorker_js__["a" /* JSONWorker */](ctx, createData);
    });
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_services_editorSimpleWorker_js__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__base_common_worker_simpleWorker_js__ = __webpack_require__(41);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_common_uri_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__base_common_winjs_base_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_range_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__diff_diffComputer_js__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__base_common_diff_diff_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__core_position_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__model_mirrorTextModel_js__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__modes_linkComputer_js__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__modes_supports_inplaceReplaceSupport_js__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__model_wordHelper_js__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__standalone_standaloneBase_js__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__base_common_platform_js__ = __webpack_require__(7);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var BaseEditorSimpleWorker = /** @class */ (function () {
    ...
    BaseEditorSimpleWorker.prototype.computeDiff = function (originalUrl, modifiedUrl, ignoreTrimWhitespace) {
        ...
        return __WEBPACK_IMPORTED_MODULE_1__base_common_winjs_base_js__["a" /* TPromise */].as(diffComputer.computeDiff());
    };
    BaseEditorSimpleWorker.prototype.computeMoreMinimalEdits = function (modelUrl, edits) {
        var model = this._getModel(modelUrl);
        if (!model) {
            return __WEBPACK_IMPORTED_MODULE_1__base_common_winjs_base_js__["a" /* TPromise */].as(edits);
        }
        var result = [];
        var lastEol;
        ...
        return __WEBPACK_IMPORTED_MODULE_1__base_common_winjs_base_js__["a" /* TPromise */].as(result);
    };
    // ---- END minimal edits ---------------------------------------------------------------
    BaseEditorSimpleWorker.prototype.computeLinks = function (modelUrl) {
        ...
        return __WEBPACK_IMPORTED_MODULE_1__base_common_winjs_base_js__["a" /* TPromise */].as(Object(__WEBPACK_IMPORTED_MODULE_7__modes_linkComputer_js__["a" /* computeLinks */])(model));
    };
    BaseEditorSimpleWorker.prototype.textualSuggest = function (modelUrl, position, wordDef, wordDefFlags) {
        ...
        if (model) {
            ...
            return __WEBPACK_IMPORTED_MODULE_1__base_common_winjs_base_js__["a" /* TPromise */].as({ suggestions: suggestions });
        }
        return undefined;
    };
    // ---- END suggest --------------------------------------------------------------------------
    ...
    BaseEditorSimpleWorker.prototype.loadForeignModule = function (moduleId, createData) {
        ...
        if (this._foreignModuleFactory) {
            ...
            return __WEBPACK_IMPORTED_MODULE_1__base_common_winjs_base_js__["a" /* TPromise */].as(methods);
        }
        // ESM-comment-begin
        ...
        // ESM-comment-end
        // ESM-uncomment-begin
        return __WEBPACK_IMPORTED_MODULE_1__base_common_winjs_base_js__["a" /* TPromise */].wrapError(new Error("Unexpected usage"));
        // ESM-uncomment-end
    };
    // foreign method request
    BaseEditorSimpleWorker.prototype.fmr = function (method, args) {
        if (!this._foreignModule || typeof this._foreignModule[method] !== 'function') {
            return __WEBPACK_IMPORTED_MODULE_1__base_common_winjs_base_js__["a" /* TPromise */].wrapError(new Error('Missing requestHandler or method: ' + method));
        }
        try {
            return __WEBPACK_IMPORTED_MODULE_1__base_common_winjs_base_js__["a" /* TPromise */].as(this._foreignModule[method].apply(this._foreignModule, args));
        }
        catch (e) {
            return __WEBPACK_IMPORTED_MODULE_1__base_common_winjs_base_js__["a" /* TPromise */].wrapError(e);
        }
    };
    // ---- END diff --------------------------------------------------------------------------
    // ---- BEGIN minimal edits ---------------------------------------------------------------
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_common_diff_diff_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__base_common_strings_js__ = __webpack_require__(28);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__viewModel_prefixSumComputer_js__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_position_js__ = __webpack_require__(2);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_uint_js__ = __webpack_require__(10);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_characterClassifier_js__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_uint_js__ = __webpack_require__(10);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__uint_js__ = __webpack_require__(10);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
"use strict";
/* unused harmony export MarkerTag */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_common_event_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__base_common_keyCodes_js__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_position_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_range_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__core_selection_js__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__base_common_winjs_base_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__base_common_cancellation_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__core_token_js__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__base_common_uri_js__ = __webpack_require__(15);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function createMonacoBaseAPI() {
    return {
        ...
        MarkerSeverity: MarkerSeverity,
        MarkerTag: MarkerTag,
        Promise: __WEBPACK_IMPORTED_MODULE_5__base_common_winjs_base_js__["a" /* TPromise */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__range_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__position_js__ = __webpack_require__(2);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* unused harmony export create */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__errors_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lifecycle_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__winjs_base_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__async_js__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__platform_js__ = __webpack_require__(7);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var SimpleWorkerProtocol = /** @class */ (function () {
    ...
    SimpleWorkerProtocol.prototype.sendMessage = function (method, args) {
        ...
        var result = new __WEBPACK_IMPORTED_MODULE_2__winjs_base_js__["a" /* TPromise */](function (c, e) {
            reply.c = c;
            reply.e = e;
        }, function () {
...
var SimpleWorkerClient = /** @class */ (function (_super) {
    ...
    function SimpleWorkerClient(workerFactory, moduleId) {
        ...
        _this._protocol = new SimpleWorkerProtocol({
            ...
            handleMessage: function (method, args) {
                ...
                return __WEBPACK_IMPORTED_MODULE_2__winjs_base_js__["a" /* TPromise */].as(null);
            }
        });
        ...
        _this._lazyProxy = new __WEBPACK_IMPORTED_MODULE_2__winjs_base_js__["a" /* TPromise */](function (c, e) {
            lazyProxyFulfill = c;
            lazyProxyReject = e;
        }, function () { });
    ...
    SimpleWorkerClient.prototype._request = function (method, args) {
        var _this = this;
        return new __WEBPACK_IMPORTED_MODULE_2__winjs_base_js__["a" /* TPromise */](function (c, e) {
...
var SimpleWorkerServer = /** @class */ (function () {
    ...
    SimpleWorkerServer.prototype._handleMessage = function (method, args) {
        ...
        if (!this._requestHandler || typeof this._requestHandler[method] !== 'function') {
            return __WEBPACK_IMPORTED_MODULE_2__winjs_base_js__["a" /* TPromise */].wrapError(new Error('Missing requestHandler or method: ' + method));
        }
        try {
            return __WEBPACK_IMPORTED_MODULE_2__winjs_base_js__["a" /* TPromise */].as(this._requestHandler[method].apply(this._requestHandler, args));
        }
        catch (e) {
            return __WEBPACK_IMPORTED_MODULE_2__winjs_base_js__["a" /* TPromise */].wrapError(e);
        }
    };
    SimpleWorkerServer.prototype.initialize = function (workerId, moduleId, loaderConfig) {
        ...
        if (this._requestHandler) {
            ...
            return __WEBPACK_IMPORTED_MODULE_2__winjs_base_js__["a" /* TPromise */].as(methods);
        }
        if (loaderConfig) {
        ...
        var cc;
        var ee;
        var r = new __WEBPACK_IMPORTED_MODULE_2__winjs_base_js__["a" /* TPromise */](function (c, e) {
            cc = c;
            ee = e;
        });
...
/* unused harmony export toThenable */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__errors_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__winjs_base_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cancellation_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lifecycle_js__ = __webpack_require__(12);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function toThenable(arg) {
    if (isThenable(arg)) {
        ...
        return __WEBPACK_IMPORTED_MODULE_1__winjs_base_js__["a" /* TPromise */].as(arg);
    }
}
function createCancelablePromise(callback) {
    ...
    var promise = new Promise(function (resolve, reject) {
        source.token.onCancellationRequested(function () {
            reject(__WEBPACK_IMPORTED_MODULE_0__errors_js__["a" /* canceled */]());
        });
...
function asWinJsPromise(callback) {
    var source = new __WEBPACK_IMPORTED_MODULE_2__cancellation_js__["a" /* CancellationTokenSource */]();
    return new __WEBPACK_IMPORTED_MODULE_1__winjs_base_js__["a" /* TPromise */](function (resolve, reject, progress) {
        var item = callback(source.token);
        if (item instanceof __WEBPACK_IMPORTED_MODULE_1__winjs_base_js__["a" /* TPromise */]) {
    ...
    if (resolveAsUndefinedWhenCancelled) {
        promise = promise.then(undefined, function (err) {
            if (!__WEBPACK_IMPORTED_MODULE_0__errors_js__["b" /* isPromiseCanceledError */](err)) {
                return __WEBPACK_IMPORTED_MODULE_1__winjs_base_js__["a" /* TPromise */].wrapError(err);
            }
            return undefined;
        });
    }
    ...
    Throttler.prototype.queue = function (promiseFactory) {
        ...
        if (this.activePromise) {
            ...
            if (!this.queuedPromise) {
                ...
                this.queuedPromise = new __WEBPACK_IMPORTED_MODULE_1__winjs_base_js__["a" /* TPromise */](function (c, e, p) {
                    _this.activePromise.then(onComplete_1, onComplete_1, p).done(c);
                }, function () {
                    _this.activePromise.cancel();
                });
            }
            return new __WEBPACK_IMPORTED_MODULE_1__winjs_base_js__["a" /* TPromise */](function (c, e, p) {
...
var Delayer = /** @class */ (function () {
    ...
    Delayer.prototype.trigger = function (task, delay) {
        ...
        if (!this.completionPromise) {
            this.completionPromise = new __WEBPACK_IMPORTED_MODULE_1__winjs_base_js__["a" /* TPromise */](function (c) {
                _this.onSuccess = c;
            }, function () {
                // no-op
            }).then(function () {
...
}(__WEBPACK_IMPORTED_MODULE_1__winjs_base_js__["a" /* TPromise */]));
...
function isWinJSPromise(candidate) {
    return __WEBPACK_IMPORTED_MODULE_1__winjs_base_js__["a" /* TPromise */].is(candidate) && typeof candidate.done === 'function';
}
...
function first(promiseFactories, shouldStop, defaultValue) {
    ...
    var loop = function () {
        if (index >= len) {
            return __WEBPACK_IMPORTED_MODULE_1__winjs_base_js__["a" /* TPromise */].as(defaultValue);
        }
        var factory = promiseFactories[index++];
        var promise = factory();
        return promise.then(function (result) {
            if (shouldStop(result)) {
                return __WEBPACK_IMPORTED_MODULE_1__winjs_base_js__["a" /* TPromise */].as(result);
            }
            return loop();
        });
    };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JSONWorker; });
/* unused harmony export create */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__deps_vscode_json_languageservice_jsonLanguageService_js__ = __webpack_require__(44);
...
var JSONWorker = /** @class */ (function () {
    function JSONWorker(ctx, createData) {
        ...
        this._languageService = __WEBPACK_IMPORTED_MODULE_0__deps_vscode_json_languageservice_jsonLanguageService_js__["a" /* getLanguageService */]({ promiseConstructor: PromiseAdapter });
    ...
    JSONWorker.prototype._getTextDocument = function (uri) {
        ...
        for (var _i = 0, models_1 = models; _i < models_1.length; _i++) {
            ...
            if (model.uri.toString() === uri) {
                return __WEBPACK_IMPORTED_MODULE_1__deps_vscode_languageserver_types_main_js__["k" /* TextDocument */].create(uri, this._languageId, model.version, model.getValue());
            }
        }
        return null;
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_jsonCompletion_js__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_jsonHover_js__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_jsonValidation_js__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_jsonDocumentSymbols_js__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__parser_jsonParser_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_configuration_js__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_jsonSchemaService_js__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__services_jsonFolding_js__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__jsonc_parser_main_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__jsonLanguageTypes_js__ = __webpack_require__(6);
/* unused harmony namespace reexport */
/* unused harmony reexport TextDocument */
/* unused harmony reexport Position */
/* unused harmony reexport CompletionItem */
/* unused harmony reexport CompletionList */
/* unused harmony reexport Hover */
/* unused harmony reexport Range */
/* unused harmony reexport SymbolInformation */
/* unused harmony reexport Diagnostic */
/* unused harmony reexport TextEdit */
/* unused harmony reexport FormattingOptions */
/* unused harmony reexport MarkedString */
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function getLanguageService(params) {
    ...
    var jsonSchemaService = new __WEBPACK_IMPORTED_MODULE_7__services_jsonSchemaService_js__["a" /* JSONSchemaService */](params.schemaRequestService, params.workspaceContext, promise);
    jsonSchemaService.setSchemaContributions(__WEBPACK_IMPORTED_MODULE_6__services_configuration_js__["a" /* schemaContributions */]);
    var jsonCompletion = new __WEBPACK_IMPORTED_MODULE_1__services_jsonCompletion_js__["a" /* JSONCompletion */](jsonSchemaService, params.contributions, promise);
    var jsonHover = new __WEBPACK_IMPORTED_MODULE_2__services_jsonHover_js__["a" /* JSONHover */](jsonSchemaService, params.contributions, promise);
    var jsonDocumentSymbols = new __WEBPACK_IMPORTED_MODULE_4__services_jsonDocumentSymbols_js__["a" /* JSONDocumentSymbols */](jsonSchemaService);
    var jsonValidation = new __WEBPACK_IMPORTED_MODULE_3__services_jsonValidation_js__["a" /* JSONValidation */](jsonSchemaService, promise);
    return {
        ...
        parseJSONDocument: function (document) { return Object(__WEBPACK_IMPORTED_MODULE_5__parser_jsonParser_js__["f" /* parse */])(document, { collectComments: true }); },
        newJSONDocument: function (root, diagnostics) { return Object(__WEBPACK_IMPORTED_MODULE_5__parser_jsonParser_js__["e" /* newJSONDocument */])(root, diagnostics); },
        ...
        getFoldingRanges: __WEBPACK_IMPORTED_MODULE_8__services_jsonFolding_js__["a" /* getFoldingRanges */],
        format: function (d, r, o) {
            ...
            return Object(__WEBPACK_IMPORTED_MODULE_9__jsonc_parser_main_js__["c" /* format */])(d.getText(), range, options).map(function (e) {
                return __WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__["l" /* TextEdit */].replace(__WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__["i" /* Range */].create(d.positionAt(e.offset), d.positionAt(e.offset + e.length)), e.content);
            });
        }
    };
}
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JSONCompletion; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__parser_jsonParser_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__jsonc_parser_main_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_json_js__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_strings_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__vscode_languageserver_types_main_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__fillers_vscode_nls_js__ = __webpack_require__(5);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var JSONCompletion = /** @class */ (function () {
    ...
    JSONCompletion.prototype.doComplete = function (document, position, doc) {
        ...
        if (node && (node.type === 'string' || node.type === 'number' || node.type === 'boolean' || node.type === 'null')) {
            overwriteRange = __WEBPACK_IMPORTED_MODULE_4__vscode_languageserver_types_main_js__["i" /* Range */].create(document.positionAt(node.offset), document.positionAt(node.offset + node.length));
        }
        else {
            ...
            overwriteRange = __WEBPACK_IMPORTED_MODULE_4__vscode_languageserver_types_main_js__["i" /* Range */].create(document.positionAt(overwriteStart), position);
        }
        var proposed = {};
        var collector = {
            add: function (suggestion) {
                ...
                if (!existing) {
                    ...
                    if (overwriteRange) {
                        suggestion.textEdit = __WEBPACK_IMPORTED_MODULE_4__vscode_languageserver_types_main_js__["l" /* TextEdit */].replace(overwriteRange, suggestion.insertText);
                    }
            ...
            if (node && node.type === 'object') {
                ...
                properties.forEach(function (p) {
                    if (!currentProperty || currentProperty !== p) {
                        proposed[p.keyNode.value] = __WEBPACK_IMPORTED_MODULE_4__vscode_languageserver_types_main_js__["a" /* CompletionItem */].create('__');
                    }
                });
                ...
                var location_1 = __WEBPACK_IMPORTED_MODULE_0__parser_jsonParser_js__["c" /* getNodePath */](node);
                ...
                if ((!schema && currentWord.length > 0 && document.getText().charAt(offset - currentWord.length - 1) !== '"')) {
                    collector.add({
                        kind: __WEBPACK_IMPORTED_MODULE_4__vscode_languageserver_types_main_js__["b" /* CompletionItemKind */].Property,
                        label: _this.getLabelForValue(currentWord),
                        insertText: _this.getInsertTextForProperty(currentWord, null, false, separatorAfter_1),
                        insertTextFormat: __WEBPACK_IMPORTED_MODULE_4__vscode_languageserver_types_main_js__["f" /* InsertTextFormat */].Snippet, documentation: ''
                    });
                }
            }
                    ...
                    Object.keys(schemaProperties_1).forEach(function (key) {
                        ...
                        if (typeof propertySchema === 'object' && !propertySchema.deprecationMessage && !propertySchema.doNotSuggest) {
                            var proposal = {
                                ...
                                insertTextFormat: __WEBPACK_IMPORTED_MODULE_4__vscode_languageserver_types_main_js__["f" /* InsertTextFormat */].Snippet,
                                filterText: _this.getFilterTextForValue(key),
                                documentation: propertySchema.description || '',
                            };
                            if (Object(__WEBPACK_IMPORTED_MODULE_3__utils_strings_js__["b" /* endsWith */])(proposal.insertText, "$1" + separatorAfter)) {
                                proposal.command = {
                                    title: 'Suggest',
    ...
    JSONCompletion.prototype.getSchemaLessValueCompletions = function (doc, node, offset, document, collector) {
        ...
        var collectSuggestionsForValues = function (value) {
            if (!__WEBPACK_IMPORTED_MODULE_0__parser_jsonParser_js__["b" /* contains */](value.parent, offset, true)) {
                collector.add({
        ...
        if (!node) {
            ...
            if ((node.type === 'property') && offset > node.colonOffset) {
                ...
                if (!valueNode || offset <= (valueNode.offset + valueNode.length)) {
                    var location_2 = __WEBPACK_IMPORTED_MODULE_0__parser_jsonParser_js__["c" /* getNodePath */](node.parent);
                    this.contributions.forEach(function (contribution) {
    ...
    JSONCompletion.prototype.addDollarSchemaCompletions = function (separatorAfter, collector) {
        ...
        schemaIds.forEach(function (schemaId) { return collector.add({
            kind: __WEBPACK_IMPORTED_MODULE_4__vscode_languageserver_types_main_js__["b" /* CompletionItemKind */].Module,
    ...
    JSONCompletion.prototype.getInsertTextForSnippetValue = function (value, separatorAfter) {
        ...
        return Object(__WEBPACK_IMPORTED_MODULE_2__utils_json_js__["a" /* stringifyObject */])(value, '', replacer) + separatorAfter;
    };
    ...
    JSONCompletion.prototype.getSuggestionKind = function (type) {
        ...
        if (!type) {
            return __WEBPACK_IMPORTED_MODULE_4__vscode_languageserver_types_main_js__["b" /* CompletionItemKind */].Value;
        }
        switch (type) {
            case 'string': return __WEBPACK_IMPORTED_MODULE_4__vscode_languageserver_types_main_js__["b" /* CompletionItemKind */].Value;
            case 'object': return __WEBPACK_IMPORTED_MODULE_4__vscode_languageserver_types_main_js__["b" /* CompletionItemKind */].Module;
            case 'property': return __WEBPACK_IMPORTED_MODULE_4__vscode_languageserver_types_main_js__["b" /* CompletionItemKind */].Property;
            default: return __WEBPACK_IMPORTED_MODULE_4__vscode_languageserver_types_main_js__["b" /* CompletionItemKind */].Value;
        }
    };
    ...
    JSONCompletion.prototype.evaluateSeparatorAfter = function (document, offset) {
        var scanner = __WEBPACK_IMPORTED_MODULE_1__jsonc_parser_main_js__["a" /* createScanner */](document.getText(), true);
    ...
    JSONCompletion.prototype.isInComment = function (document, start, offset) {
        var scanner = __WEBPACK_IMPORTED_MODULE_1__jsonc_parser_main_js__["a" /* createScanner */](document.getText(), false);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__format_js__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__parser_js__ = __webpack_require__(21);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = stringifyObject;
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JSONHover; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__parser_jsonParser_js__ = __webpack_require__(3);
...
var JSONHover = /** @class */ (function () {
    ...
    JSONHover.prototype.doHover = function (document, position, doc) {
        ...
        var hoverRange = __WEBPACK_IMPORTED_MODULE_1__vscode_languageserver_types_main_js__["i" /* Range */].create(document.positionAt(hoverRangeNode.offset), document.positionAt(hoverRangeNode.offset + hoverRangeNode.length));
        ...
        var location = __WEBPACK_IMPORTED_MODULE_0__parser_jsonParser_js__["c" /* getNodePath */](node);
        for (var i = this.contributions.length - 1; i >= 0; i--) {
            ...
            if (schema) {
                ...
                matchingSchemas.every(function (s) {
                    if (s.node === node && !s.inverted && s.schema) {
                        ...
                        if (s.schema.enum) {
                            var idx = s.schema.enum.indexOf(__WEBPACK_IMPORTED_MODULE_0__parser_jsonParser_js__["d" /* getNodeValue */](node));
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JSONValidation; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__fillers_vscode_nls_js__ = __webpack_require__(5);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var JSONValidation = /** @class */ (function () {
    ...
    JSONValidation.prototype.configure = function (raw) {
        if (raw) {
            ...
            this.commentSeverity = raw.allowComments ? void 0 : __WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Error;
        }
    };
    JSONValidation.prototype.doValidation = function (textDocument, jsonDocument, documentSettings, schema) {
        ...
        var getDiagnostics = function (schema) {
            var trailingCommaSeverity = documentSettings ? toDiagnosticSeverity(documentSettings.trailingCommas) : __WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Error;
            ...
            if (schema) {
                if (schema.errors.length && jsonDocument.root) {
                    ...
                    if (property && property.keyNode.value === '$schema') {
                        ...
                        var range = __WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__["i" /* Range */].create(textDocument.positionAt(node.offset), textDocument.positionAt(node.offset + node.length));
                        addProblem(__WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__["c" /* Diagnostic */].create(range, schema.errors[0], __WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Warning, __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["a" /* ErrorCode */].SchemaResolveError));
                    }
                    else {
                        var range = __WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__["i" /* Range */].create(textDocument.positionAt(astRoot.offset), textDocument.positionAt(astRoot.offset + 1));
                        addProblem(__WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__["c" /* Diagnostic */].create(range, schema.errors[0], __WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Warning, __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["a" /* ErrorCode */].SchemaResolveError));
                    }
                }
                else {
            ...
            jsonDocument.syntaxErrors.forEach(function (p) {
                if (p.code === __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["a" /* ErrorCode */].TrailingComma) {
            ...
            if (typeof commentSeverity === 'number') {
                ...
                jsonDocument.comments.forEach(function (c) {
                    addProblem(__WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__["c" /* Diagnostic */].create(c, message_1, commentSeverity, __WEBPACK_IMPORTED_MODULE_1__jsonLanguageTypes_js__["a" /* ErrorCode */].CommentNotPermitted));
                });
            }
            return diagnostics;
        };
...
function toDiagnosticSeverity(severityLevel) {
    switch (severityLevel) {
        case 'error': return __WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Error;
        case 'warning': return __WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__["d" /* DiagnosticSeverity */].Warning;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JSONDocumentSymbols; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__parser_jsonParser_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_strings_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_colors_js__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vscode_languageserver_types_main_js__ = __webpack_require__(0);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var JSONDocumentSymbols = /** @class */ (function () {
    ...
    JSONDocumentSymbols.prototype.findDocumentSymbols = function (document, doc) {
        ...
        if ((resourceString === 'vscode://defaultsettings/keybindings.json') || __WEBPACK_IMPORTED_MODULE_1__utils_strings_js__["b" /* endsWith */](resourceString.toLowerCase(), '/user/keybindings.json')) {
            if (root.type === 'array') {
                var result_1 = [];
                        ...
                        for (var _i = 0, _a = item.properties; _i < _a.length; _i++) {
                            ...
                            if (property.keyNode.value === 'key') {
                                if (property.valueNode) {
                                    var location = __WEBPACK_IMPORTED_MODULE_3__vscode_languageserver_types_main_js__["g" /* Location */].create(document.uri, __WEBPACK_IMPORTED_MODULE_3__vscode_languageserver_types_main_js__["i" /* Range */].create(document.positionAt(item.offset), document.positionAt(item.offset + item.length)));
                                    result_1.push({ name: __WEBPACK_IMPORTED_MODULE_0__parser_jsonParser_js__["d" /* getNodeValue */](property.valueNode), kind: __WEBPACK_IMPORTED_MODULE_3__vscode_languageserver_types_main_js__["j" /* SymbolKind */].Function, location: location });
                                }
                                return;
                            }
                        }
        ...
        var collectOutlineEntries = function (result, node, containerName) {
            if (node.type === 'array') {
                ...
                node.properties.forEach(function (property) {
                    var location = __WEBPACK_IMPORTED_MODULE_3__vscode_languageserver_types_main_js__["g" /* Location */].create(document.uri, __WEBPACK_IMPORTED_MODULE_3__vscode_languageserver_types_main_js__["i" /* Range */].create(document.positionAt(property.offset), document.positionAt(property.offset + property.length)));
    ...
    JSONDocumentSymbols.prototype.getSymbolKind = function (nodeType) {
        switch (nodeType) {
            case 'object':
                return __WEBPACK_IMPORTED_MODULE_3__vscode_languageserver_types_main_js__["j" /* SymbolKind */].Module;
            case 'string':
                return __WEBPACK_IMPORTED_MODULE_3__vscode_languageserver_types_main_js__["j" /* SymbolKind */].String;
            case 'number':
                return __WEBPACK_IMPORTED_MODULE_3__vscode_languageserver_types_main_js__["j" /* SymbolKind */].Number;
            case 'array':
                return __WEBPACK_IMPORTED_MODULE_3__vscode_languageserver_types_main_js__["j" /* SymbolKind */].Array;
            case 'boolean':
                return __WEBPACK_IMPORTED_MODULE_3__vscode_languageserver_types_main_js__["j" /* SymbolKind */].Boolean;
            default: // 'null'
                return __WEBPACK_IMPORTED_MODULE_3__vscode_languageserver_types_main_js__["j" /* SymbolKind */].Variable;
        }
    };
                ...
                for (var _i = 0, matchingSchemas_1 = matchingSchemas; _i < matchingSchemas_1.length; _i++) {
                    ...
                    if (!s.inverted && s.schema && (s.schema.format === 'color' || s.schema.format === 'color-hex') && s.node && s.node.type === 'string') {
                        ...
                        if (!visitedNode[nodeId]) {
                            var color = Object(__WEBPACK_IMPORTED_MODULE_2__utils_colors_js__["a" /* colorFromHex */])(__WEBPACK_IMPORTED_MODULE_0__parser_jsonParser_js__["d" /* getNodeValue */](s.node));
                            if (color) {
                                var range = __WEBPACK_IMPORTED_MODULE_3__vscode_languageserver_types_main_js__["i" /* Range */].create(document.positionAt(s.node.offset), document.positionAt(s.node.offset + s.node.length));
    ...
    JSONDocumentSymbols.prototype.getColorPresentations = function (document, doc, color, range) {
        ...
        result.push({ label: label, textEdit: __WEBPACK_IMPORTED_MODULE_3__vscode_languageserver_types_main_js__["l" /* TextEdit */].replace(range, JSON.stringify(label)) });
        return result;
    };
...
"use strict";
/* unused harmony export hexDigit */
/* harmony export (immutable) */ __webpack_exports__["a"] = colorFromHex;
/* unused harmony export colorFrom256RGB */
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return schemaContributions; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fillers_vscode_nls_js__ = __webpack_require__(5);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
"use strict";
/* unused harmony export UnresolvedSchema */
/* unused harmony export ResolvedSchema */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JSONSchemaService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__jsonc_parser_main_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vscode_uri_index_js__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_strings_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__parser_jsonParser_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__fillers_vscode_nls_js__ = __webpack_require__(5);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
var localize = __WEBPACK_IMPORTED_MODULE_4__fillers_vscode_nls_js__["a" /* loadMessageBundle */]();
var FilePatternAssociation = /** @class */ (function () {
    function FilePatternAssociation(pattern) {
        try {
            this.patternRegExp = new RegExp(__WEBPACK_IMPORTED_MODULE_2__utils_strings_js__["a" /* convertSimple2RegExpPattern */](pattern) + '$');
        }
        catch (e) {
            // invalid pattern
...
var ResolvedSchema = /** @class */ (function () {
    ...
    ResolvedSchema.prototype.getSection = function (path) {
        return __WEBPACK_IMPORTED_MODULE_3__parser_jsonParser_js__["a" /* asSchema */](this.getSectionRecursive(path, this.schema));
    };
...
var JSONSchemaService = /** @class */ (function () {
    ...
    JSONSchemaService.prototype.getRegisteredSchemaIds = function (filter) {
        return Object.keys(this.registeredSchemasIds).filter(function (id) {
            var scheme = __WEBPACK_IMPORTED_MODULE_1__vscode_uri_index_js__["a" /* default */].parse(id).scheme;
    ...
    JSONSchemaService.prototype.normalizeId = function (id) {
        ...
        return __WEBPACK_IMPORTED_MODULE_1__vscode_uri_index_js__["a" /* default */].parse(id).toString();
    };
    ...
    JSONSchemaService.prototype.loadSchema = function (url) {
        ...
        return this.requestService(url).then(function (content) {
            ...
            var schemaContent = {};
            var jsonErrors = [];
            schemaContent = __WEBPACK_IMPORTED_MODULE_0__jsonc_parser_main_js__["f" /* parse */](content, jsonErrors);
    ...
    JSONSchemaService.prototype.getSchemaForResource = function (resource, document) {
        ...
        if (document && document.root && document.root.type === 'object') {
            ...
            if (schemaProperties.length > 0) {
                var schemeId = __WEBPACK_IMPORTED_MODULE_3__parser_jsonParser_js__["d" /* getNodeValue */](schemaProperties[0].valueNode);
                if (schemeId && __WEBPACK_IMPORTED_MODULE_2__utils_strings_js__["c" /* startsWith */](schemeId, '.') && this.contextService) {
...
function toDisplayString(url) {
    try {
        var uri = __WEBPACK_IMPORTED_MODULE_1__vscode_uri_index_js__["a" /* default */].parse(url);
        if (uri.scheme === 'file') {
            return uri.fsPath;
        }
    }
...
function getFoldingRanges(document, context) {
    ...
    var stack = [];
    var prevStart = -1;
    var scanner = Object(__WEBPACK_IMPORTED_MODULE_1__jsonc_parser_main_js__["a" /* createScanner */])(document.getText(), false);
    var token = scanner.scan();
        ...
        switch (token) {
            ...
            case 13 /* BlockCommentTrivia */: {
                ...
                if (scanner.getTokenError() === 1 /* UnexpectedEndOfComment */ && startLine + 1 < document.lineCount) {
                    scanner.setPosition(document.offsetAt(__WEBPACK_IMPORTED_MODULE_0__vscode_languageserver_types_main_js__["h" /* Position */].create(startLine + 1, 0)));
                }
                else {
                    if (startLine < endLine) {
                        addRange({ startLine: startLine, endLine: endLine, kind: __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["b" /* FoldingRangeKind */].Comment });
                        prevStart = startLine;
                    }
                }
                break;
            ...
            case 12 /* LineCommentTrivia */: {
                ...
                if (m) {
                    ...
                    if (m[1]) { // start pattern match
                        var range = { startLine: line, endLine: line, kind: __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["b" /* FoldingRangeKind */].Region };
                        stack.push(range);
                    }
                    else {
                        var i = stack.length - 1;
                        while (i >= 0 && stack[i].kind !== __WEBPACK_IMPORTED_MODULE_2__jsonLanguageTypes_js__["b" /* FoldingRangeKind */].Region) {
                            i--;
                        }
                        if (i >= 0) {
                            var range = stack[i];
